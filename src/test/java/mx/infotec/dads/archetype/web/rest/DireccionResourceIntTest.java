...
public class DireccionResourceIntTest {
    ...
    public void setup() {
        ...
        DireccionResource direccionResource = new DireccionResource(direccionService);
    ...
    public void createDireccion() throws Exception {
        ...
        assertThat(testDireccion.getName()).isEqualTo(DEFAULT_NAME);
    }
    ...
    public void updateDireccion() throws Exception {
        ...
        Direccion testDireccion = direccionList.get(direccionList.size() - 1);
        assertThat(testDireccion.getName()).isEqualTo(UPDATED_NAME);
    }
